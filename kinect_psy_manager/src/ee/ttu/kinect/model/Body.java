...
//	}
	...
	private void calculateVelocities(boolean seatedMode) {
		...
		if (!seatedMode) {
			...
			// footRight
			ankleRight.setVelocityX(calculateVelocity(footRight.getPositionX(), oldBody.footRight.getPositionX(), timestamp, oldBody.getTimestamp()));
			ankleRight.setVelocityY(calculateVelocity(footRight.getPositionY(), oldBody.footRight.getPositionY(), timestamp, oldBody.getTimestamp()));
			ankleRight.setVelocityZ(calculateVelocity(footRight.getPositionZ(), oldBody.footRight.getPositionZ(), timestamp, oldBody.getTimestamp()));
		}
	}
