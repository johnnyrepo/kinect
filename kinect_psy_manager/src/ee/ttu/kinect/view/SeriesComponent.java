...
public class SeriesComponent extends JPanel {
	...
	public void setLabels(JointType selectedType) {
		...
		accelerationXCheckbox.setText("Acceleration X-" + selectedType.getName());
		accelerationYCheckbox.setText("Acceleration Y-" + selectedType.getName());
		accelerationZCheckbox.setText("Acceleration Z-" + selectedType.getName());
	}
	
	public void updateSeries(Body body, JointType selectedType,
			boolean seatedMode) {
	...
	private void changeSeriesVisibility(TimeSeriesCollection dataset, boolean showVelocityX, boolean showVelocityY,
			boolean showVelocityZ, boolean showAccelerationX, boolean showAccelerationY,
			boolean showAccelerationZ) {
		if (showVelocityX) {
	...
	private class ChartControlChangeListener implements ActionListener {
		...
		public synchronized void actionPerformed(ActionEvent e) {
			changeSeriesVisibility(dataset, velocityXCheckbox.isSelected(), 
					velocityYCheckbox.isSelected(), velocityZCheckbox.isSelected(), 
					accelerationXCheckbox.isSelected(), accelerationYCheckbox.isSelected(), 
